...
mixin SpacingMixin {
  ...
  double get spacing2 => 8;
  double get spacing3 => 12;
  double get spacing4 => 16;
  double get spacing5 => 20;
  double get spacing6 => 24;
  double get spacing8 => 32;
  double get spacing9 => 36;
  double get spacing10 => 40;
  double get spacing11 => 44;
  ...
  EdgeInsets get m0 => EdgeInsets.all(noSpacing);
  EdgeInsets get m0_5 => EdgeInsets.all(spacing0_5);
  EdgeInsets get m1 => EdgeInsets.all(spacing1);
  EdgeInsets get m1_5 => EdgeInsets.all(spacing1_5);
  EdgeInsets get m2 => EdgeInsets.all(spacing2);
  EdgeInsets get m3 => EdgeInsets.all(spacing3);
  EdgeInsets get m4 => EdgeInsets.all(spacing4);
  EdgeInsets get m5 => EdgeInsets.all(spacing5);
  EdgeInsets get m6 => EdgeInsets.all(spacing6);
  EdgeInsets get m8 => EdgeInsets.all(spacing8);
  EdgeInsets get m9 => EdgeInsets.all(spacing9);
  EdgeInsets get m10 => EdgeInsets.all(spacing10);
  EdgeInsets get m11 => EdgeInsets.all(spacing11);
  EdgeInsets get m12 => EdgeInsets.all(spacing12);
  EdgeInsets get m14 => EdgeInsets.all(spacing14);
  EdgeInsets get m16 => EdgeInsets.all(spacing16);
  ...
  EdgeInsets get p0 => EdgeInsets.all(noSpacing);
  EdgeInsets get p0_5 => EdgeInsets.all(spacing0_5);
  EdgeInsets get p1 => EdgeInsets.all(spacing1);
  EdgeInsets get p1_5 => EdgeInsets.all(spacing1_5);
  EdgeInsets get p2 => EdgeInsets.all(spacing2);
  EdgeInsets get p3 => EdgeInsets.all(spacing3);
  EdgeInsets get p4 => EdgeInsets.all(spacing4);
  EdgeInsets get p5 => EdgeInsets.all(spacing5);
  EdgeInsets get p6 => EdgeInsets.all(spacing6);
  EdgeInsets get p8 => EdgeInsets.all(spacing8);
  EdgeInsets get p9 => EdgeInsets.all(spacing9);
  EdgeInsets get p10 => EdgeInsets.all(spacing10);
  EdgeInsets get p11 => EdgeInsets.all(spacing11);
  EdgeInsets get p12 => EdgeInsets.all(spacing12);
  EdgeInsets get p14 => EdgeInsets.all(spacing14);
  EdgeInsets get p16 => EdgeInsets.all(spacing16);
  ...
  EdgeInsets get mx0 => EdgeInsets.symmetric(horizontal: noSpacing);
  EdgeInsets get mx0_5 => EdgeInsets.symmetric(horizontal: spacing0_5);
  EdgeInsets get mx1 => EdgeInsets.symmetric(horizontal: spacing1);
  EdgeInsets get mx1_5 => EdgeInsets.symmetric(horizontal: spacing1_5);
  EdgeInsets get mx2 => EdgeInsets.symmetric(horizontal: spacing2);
  EdgeInsets get mx3 => EdgeInsets.symmetric(horizontal: spacing3);
  EdgeInsets get mx4 => EdgeInsets.symmetric(horizontal: spacing4);
  EdgeInsets get mx5 => EdgeInsets.symmetric(horizontal: spacing5);
  EdgeInsets get mx6 => EdgeInsets.symmetric(horizontal: spacing6);
  EdgeInsets get mx8 => EdgeInsets.symmetric(horizontal: spacing8);
  EdgeInsets get mx9 => EdgeInsets.symmetric(horizontal: spacing9);
  EdgeInsets get mx10 => EdgeInsets.symmetric(horizontal: spacing10);
  EdgeInsets get mx11 => EdgeInsets.symmetric(horizontal: spacing11);
  EdgeInsets get mx12 => EdgeInsets.symmetric(horizontal: spacing12);
  EdgeInsets get mx14 => EdgeInsets.symmetric(horizontal: spacing14);
  EdgeInsets get mx16 => EdgeInsets.symmetric(horizontal: spacing16);
  ...
  EdgeInsets get px0 => EdgeInsets.symmetric(horizontal: noSpacing);
  EdgeInsets get px0_5 => EdgeInsets.symmetric(horizontal: spacing0_5);
  EdgeInsets get px1 => EdgeInsets.symmetric(horizontal: spacing1);
  EdgeInsets get px1_5 => EdgeInsets.symmetric(horizontal: spacing1_5);
  EdgeInsets get px2 => EdgeInsets.symmetric(horizontal: spacing2);
  EdgeInsets get px3 => EdgeInsets.symmetric(horizontal: spacing3);
  EdgeInsets get px4 => EdgeInsets.symmetric(horizontal: spacing4);
  EdgeInsets get px5 => EdgeInsets.symmetric(horizontal: spacing5);
  EdgeInsets get px6 => EdgeInsets.symmetric(horizontal: spacing6);
  EdgeInsets get px8 => EdgeInsets.symmetric(horizontal: spacing8);
  EdgeInsets get px9 => EdgeInsets.symmetric(horizontal: spacing9);
  EdgeInsets get px10 => EdgeInsets.symmetric(horizontal: spacing10);
  EdgeInsets get px11 => EdgeInsets.symmetric(horizontal: spacing11);
  EdgeInsets get px12 => EdgeInsets.symmetric(horizontal: spacing12);
  EdgeInsets get px14 => EdgeInsets.symmetric(horizontal: spacing14);
  EdgeInsets get px16 => EdgeInsets.symmetric(horizontal: spacing16);
  ...
  EdgeInsets get my0 => EdgeInsets.symmetric(vertical: noSpacing);
  EdgeInsets get my0_5 => EdgeInsets.symmetric(vertical: spacing0_5);
  EdgeInsets get my1 => EdgeInsets.symmetric(vertical: spacing1);
  EdgeInsets get my1_5 => EdgeInsets.symmetric(vertical: spacing1_5);
  EdgeInsets get my2 => EdgeInsets.symmetric(vertical: spacing2);
  EdgeInsets get my3 => EdgeInsets.symmetric(vertical: spacing3);
  EdgeInsets get my4 => EdgeInsets.symmetric(vertical: spacing4);
  EdgeInsets get my5 => EdgeInsets.symmetric(vertical: spacing5);
  EdgeInsets get my6 => EdgeInsets.symmetric(vertical: spacing6);
  EdgeInsets get my8 => EdgeInsets.symmetric(vertical: spacing8);
  EdgeInsets get my9 => EdgeInsets.symmetric(vertical: spacing9);
  EdgeInsets get my10 => EdgeInsets.symmetric(vertical: spacing10);
  EdgeInsets get my11 => EdgeInsets.symmetric(vertical: spacing11);
  EdgeInsets get my12 => EdgeInsets.symmetric(vertical: spacing12);
  EdgeInsets get my14 => EdgeInsets.symmetric(vertical: spacing14);
  EdgeInsets get my16 => EdgeInsets.symmetric(vertical: spacing16);
  ...
  EdgeInsets get py0 => EdgeInsets.symmetric(vertical: noSpacing);
  EdgeInsets get py0_5 => EdgeInsets.symmetric(vertical: spacing0_5);
  EdgeInsets get py1 => EdgeInsets.symmetric(vertical: spacing1);
  EdgeInsets get py1_5 => EdgeInsets.symmetric(vertical: spacing1_5);
  EdgeInsets get py2 => EdgeInsets.symmetric(vertical: spacing2);
  EdgeInsets get py3 => EdgeInsets.symmetric(vertical: spacing3);
  EdgeInsets get py4 => EdgeInsets.symmetric(vertical: spacing4);
  EdgeInsets get py5 => EdgeInsets.symmetric(vertical: spacing5);
  EdgeInsets get py6 => EdgeInsets.symmetric(vertical: spacing6);
  EdgeInsets get py8 => EdgeInsets.symmetric(vertical: spacing8);
  EdgeInsets get py9 => EdgeInsets.symmetric(vertical: spacing9);
  EdgeInsets get py10 => EdgeInsets.symmetric(vertical: spacing10);
  EdgeInsets get py11 => EdgeInsets.symmetric(vertical: spacing11);
  EdgeInsets get py12 => EdgeInsets.symmetric(vertical: spacing12);
  EdgeInsets get py14 => EdgeInsets.symmetric(vertical: spacing14);
  EdgeInsets get py16 => EdgeInsets.symmetric(vertical: spacing16);
  ...
  EdgeInsets get mt0 => EdgeInsets.only(top: noSpacing);
  EdgeInsets get mt0_5 => EdgeInsets.only(top: spacing0_5);
  EdgeInsets get mt1 => EdgeInsets.only(top: spacing1);
  EdgeInsets get mt1_5 => EdgeInsets.only(top: spacing1_5);
  EdgeInsets get mt2 => EdgeInsets.only(top: spacing2);
  EdgeInsets get mt3 => EdgeInsets.only(top: spacing3);
  EdgeInsets get mt4 => EdgeInsets.only(top: spacing4);
  EdgeInsets get mt5 => EdgeInsets.only(top: spacing5);
  EdgeInsets get mt6 => EdgeInsets.only(top: spacing6);
  EdgeInsets get mt8 => EdgeInsets.only(top: spacing8);
  EdgeInsets get mt9 => EdgeInsets.only(top: spacing9);
  EdgeInsets get mt10 => EdgeInsets.only(top: spacing10);
  EdgeInsets get mt11 => EdgeInsets.only(top: spacing11);
  EdgeInsets get mt12 => EdgeInsets.only(top: spacing12);
  EdgeInsets get mt14 => EdgeInsets.only(top: spacing14);
  EdgeInsets get mt16 => EdgeInsets.only(top: spacing16);
  ...
  EdgeInsets get pt0 => EdgeInsets.only(top: noSpacing);
  EdgeInsets get pt0_5 => EdgeInsets.only(top: spacing0_5);
  EdgeInsets get pt1 => EdgeInsets.only(top: spacing1);
  EdgeInsets get pt1_5 => EdgeInsets.only(top: spacing1_5);
  EdgeInsets get pt2 => EdgeInsets.only(top: spacing2);
  EdgeInsets get pt3 => EdgeInsets.only(top: spacing3);
  EdgeInsets get pt4 => EdgeInsets.only(top: spacing4);
  EdgeInsets get pt5 => EdgeInsets.only(top: spacing5);
  EdgeInsets get pt6 => EdgeInsets.only(top: spacing6);
  EdgeInsets get pt8 => EdgeInsets.only(top: spacing8);
  EdgeInsets get pt9 => EdgeInsets.only(top: spacing9);
  EdgeInsets get pt10 => EdgeInsets.only(top: spacing10);
  EdgeInsets get pt11 => EdgeInsets.only(top: spacing11);
  EdgeInsets get pt12 => EdgeInsets.only(top: spacing12);
  EdgeInsets get pt14 => EdgeInsets.only(top: spacing14);
  EdgeInsets get pt16 => EdgeInsets.only(top: spacing16);
  ...
  EdgeInsets get mb0 => EdgeInsets.only(bottom: noSpacing);
  EdgeInsets get mb0_5 => EdgeInsets.only(bottom: spacing0_5);
  EdgeInsets get mb1 => EdgeInsets.only(bottom: spacing1);
  EdgeInsets get mb1_5 => EdgeInsets.only(bottom: spacing1_5);
  EdgeInsets get mb2 => EdgeInsets.only(bottom: spacing2);
  EdgeInsets get mb3 => EdgeInsets.only(bottom: spacing3);
  EdgeInsets get mb4 => EdgeInsets.only(bottom: spacing4);
  EdgeInsets get mb5 => EdgeInsets.only(bottom: spacing5);
  EdgeInsets get mb6 => EdgeInsets.only(bottom: spacing6);
  EdgeInsets get mb8 => EdgeInsets.only(bottom: spacing8);
  EdgeInsets get mb9 => EdgeInsets.only(bottom: spacing9);
  EdgeInsets get mb10 => EdgeInsets.only(bottom: spacing10);
  EdgeInsets get mb11 => EdgeInsets.only(bottom: spacing11);
  EdgeInsets get mb12 => EdgeInsets.only(bottom: spacing12);
  EdgeInsets get mb14 => EdgeInsets.only(bottom: spacing14);
  EdgeInsets get mb16 => EdgeInsets.only(bottom: spacing16);
  ...
  EdgeInsets get pb0 => EdgeInsets.only(bottom: noSpacing);
  EdgeInsets get pb0_5 => EdgeInsets.only(bottom: spacing0_5);
  EdgeInsets get pb1 => EdgeInsets.only(bottom: spacing1);
  EdgeInsets get pb1_5 => EdgeInsets.only(bottom: spacing1_5);
  EdgeInsets get pb2 => EdgeInsets.only(bottom: spacing2);
  EdgeInsets get pb3 => EdgeInsets.only(bottom: spacing3);
  EdgeInsets get pb4 => EdgeInsets.only(bottom: spacing4);
  EdgeInsets get pb5 => EdgeInsets.only(bottom: spacing5);
  EdgeInsets get pb6 => EdgeInsets.only(bottom: spacing6);
  EdgeInsets get pb8 => EdgeInsets.only(bottom: spacing8);
  EdgeInsets get pb9 => EdgeInsets.only(bottom: spacing9);
  EdgeInsets get pb10 => EdgeInsets.only(bottom: spacing10);
  EdgeInsets get pb11 => EdgeInsets.only(bottom: spacing11);
  EdgeInsets get pb12 => EdgeInsets.only(bottom: spacing12);
  EdgeInsets get pb14 => EdgeInsets.only(bottom: spacing14);
  EdgeInsets get pb16 => EdgeInsets.only(bottom: spacing16);
  ...
  EdgeInsets get ml0 => EdgeInsets.only(left: noSpacing);
  EdgeInsets get ml0_5 => EdgeInsets.only(left: spacing0_5);
  EdgeInsets get ml1 => EdgeInsets.only(left: spacing1);
  EdgeInsets get ml1_5 => EdgeInsets.only(left: spacing1_5);
  EdgeInsets get ml2 => EdgeInsets.only(left: spacing2);
  EdgeInsets get ml3 => EdgeInsets.only(left: spacing3);
  EdgeInsets get ml4 => EdgeInsets.only(left: spacing4);
  EdgeInsets get ml5 => EdgeInsets.only(left: spacing5);
  EdgeInsets get ml6 => EdgeInsets.only(left: spacing6);
  EdgeInsets get ml8 => EdgeInsets.only(left: spacing8);
  EdgeInsets get ml9 => EdgeInsets.only(left: spacing9);
  EdgeInsets get ml10 => EdgeInsets.only(left: spacing10);
  EdgeInsets get ml11 => EdgeInsets.only(left: spacing11);
  EdgeInsets get ml12 => EdgeInsets.only(left: spacing12);
  EdgeInsets get ml14 => EdgeInsets.only(left: spacing14);
  EdgeInsets get ml16 => EdgeInsets.only(left: spacing16);
  ...
  EdgeInsets get pl0 => EdgeInsets.only(left: noSpacing);
  EdgeInsets get pl0_5 => EdgeInsets.only(left: spacing0_5);
  EdgeInsets get pl1 => EdgeInsets.only(left: spacing1);
  EdgeInsets get pl1_5 => EdgeInsets.only(left: spacing1_5);
  EdgeInsets get pl2 => EdgeInsets.only(left: spacing2);
  EdgeInsets get pl3 => EdgeInsets.only(left: spacing3);
  EdgeInsets get pl4 => EdgeInsets.only(left: spacing4);
  EdgeInsets get pl5 => EdgeInsets.only(left: spacing5);
  EdgeInsets get pl6 => EdgeInsets.only(left: spacing6);
  EdgeInsets get pl8 => EdgeInsets.only(left: spacing8);
  EdgeInsets get pl9 => EdgeInsets.only(left: spacing9);
  EdgeInsets get pl10 => EdgeInsets.only(left: spacing10);
  EdgeInsets get pl11 => EdgeInsets.only(left: spacing11);
  EdgeInsets get pl12 => EdgeInsets.only(left: spacing12);
  EdgeInsets get pl14 => EdgeInsets.only(left: spacing14);
  EdgeInsets get pl16 => EdgeInsets.only(left: spacing16);
  ...
  EdgeInsets get mr0 => EdgeInsets.only(right: noSpacing);
  EdgeInsets get mr0_5 => EdgeInsets.only(right: spacing0_5);
  EdgeInsets get mr1 => EdgeInsets.only(right: spacing1);
  EdgeInsets get mr1_5 => EdgeInsets.only(right: spacing1_5);
  EdgeInsets get mr2 => EdgeInsets.only(right: spacing2);
  EdgeInsets get mr3 => EdgeInsets.only(right: spacing3);
  EdgeInsets get mr4 => EdgeInsets.only(right: spacing4);
  EdgeInsets get mr5 => EdgeInsets.only(right: spacing5);
  EdgeInsets get mr6 => EdgeInsets.only(right: spacing6);
  EdgeInsets get mr8 => EdgeInsets.only(right: spacing8);
  EdgeInsets get mr9 => EdgeInsets.only(right: spacing9);
  EdgeInsets get mr10 => EdgeInsets.only(right: spacing10);
  EdgeInsets get mr11 => EdgeInsets.only(right: spacing11);
  EdgeInsets get mr12 => EdgeInsets.only(right: spacing12);
  EdgeInsets get mr14 => EdgeInsets.only(right: spacing14);
  EdgeInsets get mr16 => EdgeInsets.only(right: spacing16);
  ...
  EdgeInsets get pr0 => EdgeInsets.only(right: noSpacing);
  EdgeInsets get pr0_5 => EdgeInsets.only(right: spacing0_5);
  EdgeInsets get pr1 => EdgeInsets.only(right: spacing1);
  EdgeInsets get pr1_5 => EdgeInsets.only(right: spacing1_5);
  EdgeInsets get pr2 => EdgeInsets.only(right: spacing2);
  EdgeInsets get pr3 => EdgeInsets.only(right: spacing3);
  EdgeInsets get pr4 => EdgeInsets.only(right: spacing4);
  EdgeInsets get pr5 => EdgeInsets.only(right: spacing5);
  EdgeInsets get pr6 => EdgeInsets.only(right: spacing6);
  EdgeInsets get pr8 => EdgeInsets.only(right: spacing8);
  EdgeInsets get pr9 => EdgeInsets.only(right: spacing9);
  EdgeInsets get pr10 => EdgeInsets.only(right: spacing10);
  EdgeInsets get pr11 => EdgeInsets.only(right: spacing11);
  EdgeInsets get pr12 => EdgeInsets.only(right: spacing12);
  EdgeInsets get pr14 => EdgeInsets.only(right: spacing14);
  EdgeInsets get pr16 => EdgeInsets.only(right: spacing16);
}
